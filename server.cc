...
namespace {
class BarcodeService final : public BarcodeService::Service {
   public:
    Status ScanBarcodes(ServerContext *context, const ImageRequest *request, ScanBarcodesResponse *response) override {
        ...
        auto span  = get_tracer("grpc")->StartSpan("BarcodeService/ScanBarcodes",
                                                   {{SemanticConventions::kRpcSystem, "grpc"},
                                                    {SemanticConventions::kRpcService, "BarcodeService"},
                                                    {SemanticConventions::kRpcMethod, "ScanBarcodes"},
